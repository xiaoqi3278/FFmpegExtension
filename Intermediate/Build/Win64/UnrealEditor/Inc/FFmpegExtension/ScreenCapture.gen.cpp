...
template<> FFMPEGEXTENSION_API UScriptStruct* StaticStruct<FScreenCapInfo>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginTest_Plugins_FFmpegExtension_Source_FFmpegExtension_Public_ScreenCapture_ScreenCapture_h_Statics::ScriptStructInfo[] = {
		{ FEncodeParam::StaticStruct, Z_Construct_UScriptStruct_FEncodeParam_Statics::NewStructOps, TEXT("EncodeParam"), &Z_Registration_Info_UScriptStruct_EncodeParam, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEncodeParam), 2516912107U) },
		{ FScreenCapInfo::StaticStruct, Z_Construct_UScriptStruct_FScreenCapInfo_Statics::NewStructOps, TEXT("ScreenCapInfo"), &Z_Registration_Info_UScriptStruct_ScreenCapInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScreenCapInfo), 4178012279U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginTest_Plugins_FFmpegExtension_Source_FFmpegExtension_Public_ScreenCapture_ScreenCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UScreenCapture, UScreenCapture::StaticClass, TEXT("UScreenCapture"), &Z_Registration_Info_UClass_UScreenCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScreenCapture), 1220542791U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PluginTest_Plugins_FFmpegExtension_Source_FFmpegExtension_Public_ScreenCapture_ScreenCapture_h_788438317(TEXT("/Script/FFmpegExtension"),
